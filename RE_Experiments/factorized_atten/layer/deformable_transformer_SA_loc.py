...
# Only the location branch's factorized SA is changed to basic SA and character branch remains the same
...
class DeformableCompositeTransformerDecoderLayer(nn.Module):
    def __init__(self, d_model=256, d_ffn=1024,
        ...
        # ! HERE 
        # self attention (basic attention)
        ...
        ## attn for text branch, We will keep the factorized attention
